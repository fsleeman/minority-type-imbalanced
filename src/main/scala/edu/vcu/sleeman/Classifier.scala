...
/*  def getSmoteSample(data: Array[Array[Double]]): Unit = {
  ...
  def runSparkNN(trainData: DataFrame, testData: DataFrame, samplingMethod: String, minorityTypes: Array[Array[String]]): String = {
